---
title: My Work &#35;2&#58; 1D Su-Schrieffer-Heeger model
excerpt: Topology in one dimension
...
* [*Nat. Commun.* **7** (2016)](https://doi.org/10.1038/ncomms13986)

This was our first *science* work using the momentum-space lattice system introduced in [our first work]({{ site.baseurl }}{% post_url 2019-03-15-MyWork1 %}). I also think it was the main reason that Bryce chased momentum-space lattices in the first place. It's a very basic lattice system that had never been made before with cold atoms, and we filled that niche!
